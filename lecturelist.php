...
<html lang="en">
  ...
  <body>
    ...
    <div id="a4">Home > Admin Page </div>
		...
		<a id="a10"style="left:300px"href="studentlist.php">Student Information</a> 
        <a id="a10"style="left:600px"href="lecturer.php">Lectuer Registration</a>
        <a id="a10"style="left:900px;background-color:#666666;color:#ffffff">lecture Infromation</a>
